...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Catatan Harian'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> tambahCatatan() async {
    await SQLHelper.tambahCatatan(judulController.text, isiController.text);
    refreshCatatan();
  }

  //fungsi ubah
  Future<void> ubahCatatan(int id) async {
    await SQLHelper.ubahCatatan(id, judulController.text, isiController.text);
    refreshCatatan();
  }
